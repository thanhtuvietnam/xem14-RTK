...
//   const shuffledFilms = useMemo(() => shuffleAndSliceArray(films?.Phimmoi || [], 20), [films?.Phimmoi]);

//   // Function to safely extract the original image URL from the Cloudinary transformation URL
//   const getOriginalImageUrl = (url) => {
//     if (typeof url !== 'string') {
//       console.log('Image URL is not a string:', url);
//       return null;
//     }
...
//       >
//         {shuffledFilms.map((film, index) => {
//           const imageUrl = getOriginalImageUrl(`${IMG_URL}/${film?.poster_url}`);
//           return (
//             <SwiperSlide
//               key={film?._id || index}
//               onMouseEnter={handleMouseEnter}
...
//                   />
//                 ) : (
//                   <div className="h-64 sm:h-80 md:h-96 lg:h-[720px] w-full bg-gray-300 flex items-center justify-center rounded-lg">
